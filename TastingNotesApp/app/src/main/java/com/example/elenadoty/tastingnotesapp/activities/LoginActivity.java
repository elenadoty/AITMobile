...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    void SignIn(){
        ...
        LoginWithEmail(mEmailView.getText().toString(), mPasswordView.getText().toString());
    }
    ...
    void Register(){
        ...
        if(firebaseAuth == null) Log.d("firebase22", "firebase null");

        RegisterWithEmail(mEmailView.getText().toString(), mPasswordView.getText().toString());
    }
    ...
    private void RegisterWithEmail(final String mEmail, final String mPassword){
    ...
    private void LoginWithEmail(final String mEmail, final String mPassword){
